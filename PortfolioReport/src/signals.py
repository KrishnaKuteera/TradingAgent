...
_EVALUATORS = {
    ...
    "canslim_a_earnings":    lambda rule, pos, tech, bal: _eval_canslim_a(rule, tech),
    ...
    "buy_base_volume":       lambda rule, pos, tech, bal: _result(rule, NA, "Manual review — check base pattern on chart"),
    "buy_not_bear_market":   lambda rule, pos, tech, bal: _result(rule, NA, "Covered by canslim_m"),
    "sell_8_week_hold":      lambda rule, pos, tech, bal: _result(rule, NA, "Manual review — 8-week hold rule"),
    "market_bear_signal":    lambda rule, pos, tech, bal: _result(rule, NA, "Covered by canslim_m"),
